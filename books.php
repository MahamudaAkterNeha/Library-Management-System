...
<body>
    ...
    <div class="wrapper" style="overflow: auto;">
        ...
        <div id="main" style="background-image: url(images/books.jpg);">
            ...
            onclick="openNav()">&#9776; Issue Books</span>
            <script>
                function openNav() {
            ...
            <section>
                <div class="container-lg mt-3 border" style="margin-top: -8px">  
                    ...
                    <div class="search" style="padding-left: 1000px;">
                        <form class="navbar-form" method="post" name="form1" action="">
                            <input class="form-control" type="text" name="bid" placeholder="Enter Book ID To Request" required="" style="width: 380px;">
                            <button style="background-color: rgb(164, 89, 164);" type="submit" name="submit1" class="btn btn-default">Request</button>
                        </form>
                    </div>
                    ...
                    <?php
                        ...
                        if(isset($_POST['submit1']))
                        {
                            if(isset($_SESSION['login_user']))
                            {
                                mysqli_query($db,"INSERT INTO issuebook (username, bid, approve, issuedate, returndate)
                            ...
                            else
                            {
                                ...
                                <div class="alert alert-danger alert-dismissible"
                                    ...
                                    <strong>You Must Login To Request For A Book!</strong>
                                </div> 
                                <?php
                            }
                        }
