    ...
    <div class="wrapper">
        ...
        <section>
             <div class="registration">
                ...
                <div class="box">
                    <br>
                    <h1 style="text-align: center; font-size: 40px; color: black;">User Registration</h1><br>
        ...
        if(isset($_POST['submit']))
        {
            ...
            if($count==0)
            {
                mysqli_query($db,"INSERT INTO users (firstname, lastname, username, email, password, phonenumber, pic)
