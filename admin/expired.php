                        ...
                        if(isset($_SESSION['login_user']))
                        {
                            ...
                            <form class="navbar-form" method="post" action=""> 
                                ...
                                <button class="btn btn-default" type="submit" name="submit3" style="color:black;background-color:red;
                                    margin-left:20px;width:100px"><b>Expired</b></button>
                            </form>
                            
                            <!--FORM-->
                            <div class="search" style="padding-left: 1020px; margin-top:-40px">
                                <h5 style="color: black; margin-left: 15px;margin-top: -3px;background-color: rgb(164, 89, 164);margin-top: -3px; width:300px">
                                <b>Update status if any issued book is returned:</b></h5>
                                <form class="navbar-form" method="post" name="form" action="">
                                    ...
                                    style="background-color: rgb(164, 89, 164); margin-left: 115px"><b>Update</b></button>
                                </form>
                            </div>
                            ...
                            {
                                //UPDATE EXPIRED INFORMATION TO RETURNED
                                $var1 = '<p style="color:green;"><i>Returned</i></p>';
                                mysqli_query($db,"UPDATE `issuebook` SET approve='$var1'
