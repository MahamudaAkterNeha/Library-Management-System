        ...
        <nav>
            <?php
                ...
                <ul>         
                    ...
                    <li><a href="admin_status.php"><span class="glyphicon glyphicon-user" style="margin-right: -15px"></span>
                    <span class="badge bg-green" style="margin-left: -20px"><?php echo $a['total'];?></span></a></li>
                ...
                <ul>
                    ...
                    <li><a href="../user.php"><span class="glyphicon glyphicon-log-in"></span>ADMIN</a></li>  
                </ul>
                <?php
                }
            ?>   
